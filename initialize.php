...
if(!defined('base_url')) define('base_url','http://apcwebprog.csf.ph/~cbmedallada/purchase_order');
if(!defined('base_app')) define('base_app', str_replace('\\','/',__DIR__).'/' );
if(!defined('dev_data')) define('dev_data',$dev_data);
if(!defined('DB_SERVER')) define('DB_SERVER',"http://apcwebprog.csf.ph/notmydatabase/");
